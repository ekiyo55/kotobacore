# Annotated eval — KotobaCore 0.6.1 (300 items)
...
| Sentiment accuracy | 62.3% (n=300) |
| Emotion accuracy | 24.7% (n=182), canary FP 22.7% (n=22) |
| Intent accuracy | 13.7% (n=300) |
| Sentiment target accuracy | 45.5% (n=33) |
| Timing | mean 3.83 ms / p95 5.29 ms |

## Per genre

| genre | sentiment | emotion | intent |
|---|---|---|---|
| business | 65.0% | 30.4% | 18.3% |
| conversation | 56.7% | 19.5% | 21.7% |
| literary | 85.0% | 24.3% | 1.7% |
| sns | 55.0% | 32.6% | 16.7% |
| tech | 50.0% | 17.1% | 10.0% |
...
- `tech-029` target: gold=['エラーメッセージ'] sys=['直'] このエラーメッセージ、何を直せばいいのか全然わからない。
