...
from kotobacore.core.ir import SemanticToken, Token
...
BASE_TO_PLUTCHIK: dict[str, str] = {
    ...
    # v0.6.5: the three Plutchik primaries that were folded into other bases
    # (驚いた was exaggeration, 信頼 was admiration, 嫌悪 was refusal) — split
    # out to match the human evaluation set (gold に寄せて system を修正, 2026-09-09)
    "surprise": "surprise",
    "trust": "trust",
    "disgust": "disgust",
    "mixed": "mixed",
